<?php
/** 
*Plugin Name: VersaMaint plugin
*Plugin URL: http://wordpress.org
*Description: VersaMaint is a WordPress plugin designed to enhance maintenance mode pages with advanced customization. It allows site owners to add mobile-specific background images, set YouTube videos as backgrounds, and activate an elegant front-end login form with customizable colour settings.
*Author: Amina
*Version: 1.0.0
*/
